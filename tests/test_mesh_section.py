...
class TestMeshSectionFunctional(unittest.TestCase):
    def test_rasterizes_mesh_section_to_ros_map(self):
        ...
        occupancy = generate_section_map(
            context,
            section_height=0.232,
        )

        output_base = repo_root / "test_output" / "metashape_mesh_section"
